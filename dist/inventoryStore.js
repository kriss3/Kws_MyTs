/*
some TS Class convention:
Use _ to indicate 'private' members;
_ does not do anything and it is a convention.
Use TS access modifiers to indicate access level
TS access modifiers:
Private - only visible to member within the same class;
Protected - visible to members of the same class and derived classes
